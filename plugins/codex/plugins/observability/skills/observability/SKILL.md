...
- `tinyai_git.install_hooks`: install a local post-commit attribution hook when the repository should automatically report AI code metrics.
...
8. For manual backfill or debugging, call `tinyai_git.commit_snapshot` after committing.
