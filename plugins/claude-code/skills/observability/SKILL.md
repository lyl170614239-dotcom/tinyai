...
- `tinyai_git.install_hooks` to install a local post-commit attribution hook when the repository should automatically report AI code metrics.
...
- For code-writing tasks, record the final Git boundary with `tinyai_git.commit_snapshot` after committing.
